...
#define CRUST_BERTH_STEP_INSTRUCTION struct crustBerthStepInstruction
...
struct crustBerthStepInstruction {
    CRUST_IDENTIFIER sourceBlockID;
    CRUST_IDENTIFIER destinationBlockID;
};
